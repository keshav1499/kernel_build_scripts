...
# Copyright (C) 2026 Hrushiraj Gandhi

# Makefile for rk3588_vaaman2
# This file contains variables used for building rk3588_vaaman2 kernel
# To disable build options, comment the line or set it to false

# Device specific
DEVICE_NAME="rk3588_vaaman2"
DEVICE_DTB_FILE="rk3588-vaaman2-linux"
DEVICE_DEFCONFIG="rockchip_linux_defconfig"
DEVICE_CONFIG_FRAGMENT="rk3588_vaaman2.config"
DEVICE_ARCH="arm64"
